...
import RechargeHistoryPage from "./components/userRechargeHistory";
import UserRatingsPage from "./components/userRating";
...
const handleAddCoin = (plan) => {
  console.log('Adding coin with plan:', plan);
  // Add your coin addition logic here
  // For example: dispatch(addCoinToUser({ userId, planId: plan.id }))
};
  if (userByIdLoading) {
    return (
  ...
  const getMainStatus = (user) => {
    ...
    if (user.is_suspended)
      return { label: "Suspended", color: "yellow", icon: "⏸️" };
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div className="text-2xl font-semibold text-gray-900">
              {currentUser.stats?.coin_balance?.toLocaleString() || 0}
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div className="text-2xl font-semibold text-gray-900">
              {currentUser.stats?.total_calls?.toLocaleString() || 0}
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div className="text-2xl font-semibold text-gray-900">
              {formatSeconds(currentUser.stats?.total_call_seconds || 0)}
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <div className="text-2xl font-semibold text-gray-900">
              {formatSeconds(currentUser.stats?.total_call_seconds_today || 0)}
            </div>
          </div>
        </div>
            ...
            {currentUser.stats?.last_updated && (
              <div className="mt-5 pt-5 border-t border-gray-100">
                ...
                <div className="text-sm text-gray-700">
                  {new Date(currentUser.stats.last_updated).toLocaleDateString(
                    "en-US",
                    {
                      year: "numeric",
                      month: "short",
...
<UserRatingsPage></UserRatingsPage>
